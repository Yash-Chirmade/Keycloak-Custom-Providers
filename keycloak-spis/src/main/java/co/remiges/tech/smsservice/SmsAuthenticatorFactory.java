...
public class SmsAuthenticatorFactory implements AuthenticatorFactory{
	...
	public List<ProviderConfigProperty> getConfigProperties() {
		return List.of(
			...
			new ProviderConfigProperty("netcoreApiKey", "Email Api Key", "Api Key for sending email via Netcore", ProviderConfigProperty.PASSWORD, ""),
			new ProviderConfigProperty("netcoreApiUrl", "Email Api Url", "Api Url for sending email via Netcore", ProviderConfigProperty.STRING_TYPE, ""),
			new ProviderConfigProperty("retryAfterTime", "Retry After Time", "set retry afterTime in minutes", ProviderConfigProperty.STRING_TYPE, 30),
